                    ...
                    <div className="flex flex-col gap-6 h-fit">
                        ...
                        <div className="bg-[#0c0c0e] border border-white/10 rounded-3xl p-6">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="text-xs text-slate-500 uppercase font-bold block mb-1">Semester</label>
                                    <select value={enrollSectionForm?.semester_id || ""} onChange={e => setEnrollSectionForm({...enrollSectionForm, semester_id: e.target.value ? parseInt(e.target.value) : ""})} className="w-full bg-black border border-white/10 rounded-xl px-3 py-2 text-white text-sm outline-none">
                                        <option value="">Select Semester</option>
                                        {(allSemesters || [])
                                ...
                                <div>
                                    ...
                                    <select 
                                        ...
                                        onChange={e => setEnrollSectionForm({...enrollSectionForm, section_id: e.target.value ? parseInt(e.target.value) : ""})}
                                ...
                                <div>
                                    ...
                                    <select value={enrollSectionForm?.subject_id || ""} onChange={e => setEnrollSectionForm({...enrollSectionForm, subject_id: e.target.value ? parseInt(e.target.value) : ""})} className="w-full bg-black border border-white/10 rounded-xl px-3 py-2 text-white text-sm outline-none">
                                        <option value="">Select Subject</option>
